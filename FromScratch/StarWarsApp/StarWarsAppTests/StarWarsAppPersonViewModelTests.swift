...
class StarWarsAppPersonViewModelTests: XCTestCase {
    ...
    private func mockPlanetResponse() -> (_ index: Int) -> Observable<Response<PlanetResponse>> {
        return { index in
            let planetResponse = PlanetResponse(population: "", gravity: "", diameter: "", rotationPeriod: "", orbitalPeriod: "", name: self.personHomeworld, climate: "", terrain: "", surfaceWater: "", residents: ["",""])
